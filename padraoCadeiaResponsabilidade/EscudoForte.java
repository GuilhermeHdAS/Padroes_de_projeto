...
public class EscudoForte extends Escudo {
    ...
    public void processaEscudo(int valor, Personagem personagem) {
        ...
        if (protecao != 0){
            ...
            System.out.println("Protecao alta: "+protecao);
            
            //Ganha 10 de life, para cada decremento de protecao, valor do escudo
            while (protecao > 0){
                personagem.setLife(personagem.getLife() + 10);
                protecao--;
